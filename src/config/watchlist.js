// Full S&P 500 constituents (name + ticker). Symbols use Twelve Data format
// (e.g. Berkshire class B is "BRK.B"). Generated from the public S&P 500
// constituents dataset — refresh periodically as the index changes.
export const WATCHLIST = [
  { name: "3M", symbol: "MMM" },
  { name: "A. O. Smith", symbol: "AOS" },
  ...
  { name: "Alliant Energy", symbol: "LNT" },
  ...
  { name: "Amcor", symbol: "AMCR" },
  { name: "Ameren", symbol: "AEE" },
  ...
  { name: "Baxter International", symbol: "BAX" },
  ...
  { name: "Cooper Companies (The)", symbol: "COO" },
  { name: "Copart", symbol: "CPRT" },
  { name: "Corning Inc.", symbol: "GLW" },
  { name: "Corpay", symbol: "CPAY" },
  { name: "Corteva", symbol: "CTVA" },
  { name: "CoStar Group", symbol: "CSGP" },
  ...
  { name: "DaVita", symbol: "DVA" },
  { name: "Deckers Brands", symbol: "DECK" },
  ...
  { name: "Diamondback Energy", symbol: "FANG" },
  ...
  { name: "Elevance Health", symbol: "ELV" },
  { name: "Emcor", symbol: "EME" },
  ...
  { name: "Erie Indemnity", symbol: "ERIE" },
  { name: "Essex Property Trust", symbol: "ESS" },
  { name: "Estée Lauder Companies (The)", symbol: "EL" },
  { name: "Everest Group", symbol: "EG" },
  { name: "Evergy", symbol: "EVRG" },
  { name: "Eversource Energy", symbol: "ES" },
  { name: "Exelon", symbol: "EXC" },
  { name: "Expand Energy", symbol: "EXE" },
  ...
  { name: "FactSet", symbol: "FDS" },
  { name: "Fair Isaac", symbol: "FICO" },
  { name: "Fastenal", symbol: "FAST" },
  { name: "Federal Realty Investment Trust", symbol: "FRT" },
  { name: "FedEx", symbol: "FDX" },
  { name: "FedEx Freight", symbol: "FDXF" },
  ...
  { name: "Gartner", symbol: "IT" },
  { name: "GE Aerospace", symbol: "GE" },
  { name: "GE HealthCare", symbol: "GEHC" },
  { name: "GE Vernova", symbol: "GEV" },
  { name: "Gen Digital", symbol: "GEN" },
  { name: "Generac", symbol: "GNRC" },
  ...
  { name: "Hartford (The)", symbol: "HIG" },
  { name: "Hasbro", symbol: "HAS" },
  { name: "HCA Healthcare", symbol: "HCA" },
  { name: "Healthpeak Properties", symbol: "DOC" },
  { name: "Henry Schein", symbol: "HSIC" },
  { name: "Hershey Company (The)", symbol: "HSY" },
  { name: "Hewlett Packard Enterprise", symbol: "HPE" },
  { name: "Hilton Worldwide", symbol: "HLT" },
  { name: "Home Depot (The)", symbol: "HD" },
  { name: "Honeywell Aerospace", symbol: "HONA" },
  { name: "Honeywell Technologies", symbol: "HON" },
  ...
  { name: "Interactive Brokers", symbol: "IBKR" },
  ...
  { name: "IQVIA", symbol: "IQV" },
  { name: "Iron Mountain", symbol: "IRM" },
  { name: "J.B. Hunt", symbol: "JBHT" },
  { name: "Jabil", symbol: "JBL" },
  { name: "Jack Henry & Associates", symbol: "JKHY" },
  { name: "Jacobs Solutions", symbol: "J" },
  { name: "Johnson & Johnson", symbol: "JNJ" },
  { name: "Johnson Controls", symbol: "JCI" },
  { name: "JPMorgan Chase", symbol: "JPM" },
  { name: "Kenvue", symbol: "KVUE" },
  { name: "Keurig Dr Pepper", symbol: "KDP" },
  { name: "KeyCorp", symbol: "KEY" },
  { name: "Keysight Technologies", symbol: "KEYS" },
  ...
  { name: "Norwegian Cruise Line Holdings", symbol: "NCLH" },
  ...
  { name: "Paramount Skydance Corporation", symbol: "PSKY" },
  ...
  { name: "PulteGroup", symbol: "PHM" },
  { name: "Quanta Services", symbol: "PWR" },
  { name: "Qualcomm", symbol: "QCOM" },
  { name: "Quest Diagnostics", symbol: "DGX" },
  { name: "Qnity Electronics", symbol: "Q" },
  ...
  { name: "J.M. Smucker Company (The)", symbol: "SJM" },
  { name: "Smurfit Westrock", symbol: "SW" },
  { name: "Snap-on", symbol: "SNA" },
  { name: "Solventum", symbol: "SOLV" },
  ...
  { name: "Targa Resources", symbol: "TRGP" },
  { name: "Target Corporation", symbol: "TGT" },
  { name: "TE Connectivity", symbol: "TEL" },
  { name: "Teledyne Technologies", symbol: "TDY" },
  { name: "Teradyne", symbol: "TER" },
  ...
  { name: "TKO Group Holdings", symbol: "TKO" },
  { name: "Trade Desk (The)", symbol: "TTD" },
  { name: "Tractor Supply", symbol: "TSCO" },
  { name: "Trane Technologies", symbol: "TT" },
  { name: "TransDigm Group", symbol: "TDG" },
  { name: "Travelers Companies (The)", symbol: "TRV" },
  ...
  { name: "United Airlines Holdings", symbol: "UAL" },
  ...
  { name: "W. W. Grainger", symbol: "GWW" },
  { name: "Wabtec", symbol: "WAB" },
  ...
  { name: "Zebra Technologies", symbol: "ZBRA" },
